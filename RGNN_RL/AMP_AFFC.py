...
from ckt_graphs import GraphAMPAFFC
...
CktGraph = GraphAMPAFFC

class AMPAFFCEnv(gym.Env, CktGraph, DeviceParams):
    ...
    def _initialize_simulation(self):
        ...
        self.W_M22, self.L_M22, self.M_M22,\
        self.W_M25, self.L_M25, self.M_M25, \
        self.W_M59, self.L_M59, self.M_M59, \
        self.W_M60, self.L_M60, self.M_M60, \
        self.Ib,  \
        self.M_C0, \
        self.M_C1 = \
        np.array([1, 1, 4,       
    ...
    def _do_simulation(self, action: np.array):
        ...
        try:
            ...
            AMP_AFFC_vars = open(f'{SPICE_NETLIST_DIR}/AMP_AFFC_vars.spice', 'r')
            lines = AMP_AFFC_vars.readlines()
            lines[0] = f'.param MOSFET_0_8_W_BIASCM_PMOS={W_M0} MOSFET_0_8_L_BIASCM_PMOS={L_M0} MOSFET_0_8_M_BIASCM_PMOS={M_M0}\n'
            lines[1] = f'.param MOSFET_9_2_W_gm1_PMOS={W_M9} MOSFET_9_2_L_gm1_PMOS={L_M9} MOSFET_9_2_M_gm1_PMOS={M_M9}\n'
            lines[2] = f'.param MOSFET_11_1_W_gm2_PMOS={W_M11} MOSFET_11_1_L_gm2_PMOS={L_M11} MOSFET_11_1_M_gm2_PMOS={M_M11}\n'
            lines[3] = f'.param MOSFET_12_1_W_gmf2_PMOS={W_M12} MOSFET_12_1_L_gmf2_PMOS={L_M12} MOSFET_12_1_M_gmf2_PMOS={M_M12}\n'
            lines[4] = f'.param MOSFET_17_7_W_BIASCM_NMOS={W_M17} MOSFET_17_7_L_BIASCM_NMOS={L_M17} MOSFET_17_7_M_BIASCM_NMOS={M_M17}\n'
            lines[5] = f'.param MOSFET_18_7_W_BIASCM_NMOS={W_M18} MOSFET_18_7_L_BIASCM_NMOS={L_M18} MOSFET_18_7_M_BIASCM_NMOS={M_M18}\n'
            lines[6] = f'.param MOSFET_22_2_W_LOAD2_NMOS={W_M22} MOSFET_22_2_L_LOAD2_NMOS={L_M22} MOSFET_22_2_M_LOAD2_NMOS={M_M22}\n'
            lines[7] = f'.param MOSFET_25_1_W_gm3_NMOS={W_M25} MOSFET_25_1_L_gm3_NMOS={L_M25} MOSFET_25_1_M_gm3_NMOS={M_M25}\n'
            lines[8] = f'.param MOSFET_59_2_W_HSBCM_PMOS={W_M59} MOSFET_59_2_L_HSBCM_PMOS={L_M59} MOSFET_59_2_M_HSBCM_PMOS={M_M59}\n'
            lines[9] = f'.param MOSFET_60_2_W_gma_NMOS={W_M60} MOSFET_60_2_L_gma_NMOS={L_M60} MOSFET_60_2_M_gma_NMOS={M_M60}\n'
            lines[10] = f'.param CURRENT_0_BIAS={Ib}\n'
            lines[11] = f'.param M_C0={M_C0}\n'
            lines[12] = f'.param M_C1={M_C1}\n'
            
            AMP_AFFC_vars = open(f'{SPICE_NETLIST_DIR}/AMP_AFFC_vars.spice', 'w')
            AMP_AFFC_vars.writelines(lines)
            AMP_AFFC_vars.close()
            os.system(f'cd {SPICE_NETLIST_DIR}&& ngspice -b -o AMP_AFFC_ACDC.log AMP_AFFC_ACDC.cir')
            os.system(f'cd {SPICE_NETLIST_DIR}&& ngspice -b -o AMP_AFFC_Tran.log AMP_AFFC_Tran.cir')
    ...
    def do_simulation(self, action):
        ...
        self.op_results = self.sim_results.dcop(file_name='AMP_AFFC_op')
    ...
    def _get_obs(self):
        ...
        try:
            f = open(f'{SPICE_NETLIST_DIR}/AMP_AFFC_op_mean_std.json')
        ...
        self.OP_M25 = self.op_results['M25']
        self.OP_M25_norm = (np.array([self.OP_M25['id'],
                                self.OP_M25['gm'],
                                self.OP_M25['gds'],
                                self.OP_M25['vth'],
                                self.OP_M25['vdsat'],
        ...
        self.OP_M59 = self.op_results['M59']
        self.OP_M59_norm = (np.array([self.OP_M59['id'],
                                self.OP_M59['gm'],
                                self.OP_M59['gds'],
                                self.OP_M59['vth'],
                                self.OP_M59['vdsat'],
        ...
        self.OP_M60 = self.op_results['M60']
        self.OP_M60_norm = (np.array([self.OP_M60['id'],
                                self.OP_M60['gm'],
                                self.OP_M60['gds'],
                                self.OP_M60['vth'],
                                self.OP_M60['vdsat'],
        ...
        observation = np.array([
                               ...
                               [0,0,0,0,      0,      self.OP_M25_norm[0],self.OP_M25_norm[1],self.OP_M25_norm[2],self.OP_M25_norm[3],self.OP_M25_norm[4],self.OP_M25_norm[5],self.OP_M25_norm[6]],
                               [0,0,0,0,      0,      self.OP_M59_norm[0],self.OP_M59_norm[1],self.OP_M59_norm[2],self.OP_M59_norm[3],self.OP_M59_norm[4],self.OP_M59_norm[5],self.OP_M59_norm[6]],
                               [0,0,0,0,      0,      self.OP_M60_norm[0],self.OP_M60_norm[1],self.OP_M60_norm[2],self.OP_M60_norm[3],self.OP_M60_norm[4],self.OP_M60_norm[5],self.OP_M60_norm[6]],
                               [0,0,0,0,      0,      self.OP_M61_norm[0],self.OP_M61_norm[1],self.OP_M61_norm[2],self.OP_M61_norm[3],self.OP_M61_norm[4],self.OP_M61_norm[5],self.OP_M61_norm[6]],
                               [0,0,0,0,      0,      self.OP_M62_norm[0],self.OP_M62_norm[1],self.OP_M62_norm[2],self.OP_M62_norm[3],self.OP_M62_norm[4],self.OP_M62_norm[5],self.OP_M62_norm[6]],
                               [0,0,0,0,      0,      self.OP_M63_norm[0],self.OP_M63_norm[1],self.OP_M63_norm[2],self.OP_M63_norm[3],self.OP_M63_norm[4],self.OP_M63_norm[5],self.OP_M63_norm[6]],
                               [0,0,0,0,      0,      self.OP_M64_norm[0],self.OP_M64_norm[1],self.OP_M64_norm[2],self.OP_M64_norm[3],self.OP_M64_norm[4],self.OP_M64_norm[5],self.OP_M64_norm[6]],
    ...
    def _get_info(self):
        ...
        ''' DC '''
        self.dc_results = self.sim_results.dc(file_name='AMP_AFFC_ACDC_DC')
        ...
        ''' AC '''
        self.ac_results = self.sim_results.ac(file_name='AMP_AFFC_ACDC_AC')
        ...
        if self.dcgain > 0 :
            ...
            self.GBW_PM_results = self.sim_results.GBW_PM(file_name='AMP_AFFC_ACDC_GBW_PM')
        ...
        """ Tran """
        self.tran_results = self.sim_results.tran(file_name='AMP_AFFC_Tran')
        ...
        self.time_data, self.vin_data, self.vout_data = self.sim_results.extract_tran_data(file_name='AMP_AFFC_tran.dat')
        ...
        self.C1 = self.M_C1 * 0.8152
        self.Active_Area_1 = (self.W_M0 * self.L_M0 * self.M_M0 * 8 + self.W_M9 * self.L_M9 * self.M_M9 * 2 + self.W_M11 * self.L_M11 * self.M_M11 * 1 +\
                           self.W_M12 * self.L_M12 * self.M_M12 * 1 + self.W_M17 * self.L_M17 * self.M_M17 * 2 + self.W_M18 * self.L_M18 * self.M_M18 * 9 +\
                           self.W_M22 * self.L_M22 * self.M_M22 * 2 + self.W_M25 * self.L_M25 * self.M_M25 * 1 + self.W_M59 * self.L_M59 * self.M_M59 * 2 + self.W_M60 * self.L_M60 * self.M_M60 * 2) * 1e-6 + \
    ...
    def _init_random_sim(self, max_sims=100):
        ...
        while random_op_count <= max_sims :
            ...
            op_results = sim_results.dcop(file_name='AMP_AFFC_op')
        ...
        with open(f'{SPICE_NETLIST_DIR}/AMP_AFFC_op_mean_std.json','w') as file:
